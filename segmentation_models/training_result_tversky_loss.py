...
save_dir = '2023_09_13_Tversky_loss'
...
class LitEfficientNet(pl.LightningModule):
    def __init__(self, train_dataloader=None, val_dataloader=None, test_dataloader=None, batch_size=32):
        ...
        self.criterion = TverskyLoss(alpha=0.7, beta=0.3, ignore_index=0)
...
if not os.path.exists(f'result/{save_dir}'):
    os.makedirs(f'result/{save_dir}')
